...
import { ApiBaseUrl, getToken } from "../utils/auth";
        ...
        <Box display="flex" marginBottom={3}>
          ...
          <Box marginLeft="18px">
            ...
            <Box display="flex" alignItems="center" marginTop={2}>
              <Typography variant="body2" sx={{ fontWeight: 300, marginRight: "4px" }}>
          ...
          <Box marginLeft={6} display="flex" flexDirection="column">
            ...
            <Typography variant="body2" sx={{ fontWeight: 300, margin: "0.8rem 0" }}>
